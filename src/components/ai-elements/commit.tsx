...
export const CommitMetadata = ({ className, children, ...props }: CommitMetadataProps) => (
  <div className={cn('text-muted-foreground flex items-center gap-2 text-xs', className)} {...props}>
    {children}
  </div>
);
...
export const CommitFile = ({ className, children, ...props }: CommitFileProps) => (
  <div className={cn('hover:bg-muted/50 flex items-center justify-between gap-2 rounded px-2 py-1 text-sm', className)} {...props}>
    {children}
  </div>
);
