...
export const PackageInfoVersion = ({ className, children, ...props }: PackageInfoVersionProps) => {
  ...
  return (
    <div className={cn('text-muted-foreground mt-2 flex items-center gap-2 font-mono text-sm', className)} {...props}>
      {children ?? (
        <>
...
export const PackageInfoDependencies = ({ className, children, ...props }: PackageInfoDependenciesProps) => (
  <div className={cn('space-y-2', className)} {...props}>
    <span className="text-muted-foreground text-xs font-medium tracking-wide uppercase">Dependencies</span>
