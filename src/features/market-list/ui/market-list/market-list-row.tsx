 ...
 */
export const MarketListRow = memo(function MarketListRow({
  row,
  isFavorite = false,
  isSelected = false,
  state,
  ...
  const rowSx = useMemo(
    () =>
      ({
        ...
        backgroundColor: (theme: Theme) => (finalIsSelected ? (theme.palette.mode === 'dark' ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.03)') : 'transparent'),
