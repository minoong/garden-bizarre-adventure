...
export function useMarkets(options?: UseMarketsOptions) {
  ...
  return useQuery<Market[]>({
    queryKey: is_details ? BITHUMB_QUERY_KEYS.marketsWithDetails : BITHUMB_QUERY_KEYS.markets,
    queryFn: () => fetchMarkets({ is_details }),
    staleTime: BITHUMB_STALE_TIME.MARKETS,
    gcTime: BITHUMB_GC_TIME.MARKETS,
    enabled,
  });
}
