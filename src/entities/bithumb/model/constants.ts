...
/** 빗썸 REST API 기본 URL */
export const BITHUMB_API_BASE_URL = process.env.NEXT_PUBLIC_BITHUMB_REST_API_URL || 'https://api.bithumb.com';

/** 빗썸 WebSocket URL */
export const BITHUMB_WEBSOCKET_URL = process.env.NEXT_PUBLIC_BITHUMB_WEBSOCKET_URL
...
export const BITHUMB_ENDPOINTS = {
  /** 마켓 목록 조회 */
...
export const BITHUMB_QUERY_KEYS = {
  ...
  /** 마켓 목록 (상세) */
  marketsWithDetails: ['bithumb', 'markets', { isDetails: true }] as const,
  /** 현재가 */
  ticker: (markets: string[]) => ['bithumb', 'ticker', markets] as const,
  /** 분봉 캔들 */
  minuteCandles: (market: string, unit: MinuteUnit) => ['bithumb', 'candles', 'minutes', market, unit] as const,
  /** 일봉 캔들 */
  dayCandles: (market: string) => ['bithumb', 'candles', 'days', market] as const,
  /** 주봉 캔들 */
  weekCandles: (market: string) => ['bithumb', 'candles', 'weeks', market] as const,
  /** 월봉 캔들 */
  monthCandles: (market: string) => ['bithumb', 'candles', 'months', market] as const,
  /** 캔들 (통합) */
...
export const BITHUMB_STALE_TIME = {
  /** 마켓 목록: 5분 */
  MARKETS: 5 * 60 * 1000,
  /** 현재가: 3초 */
  TICKER: 3 * 1000,
