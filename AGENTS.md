...
- **This file (AGENTS.md)**: Project overview, technology stack, and development commands
- **`.Codex/` directory**: Detailed coding conventions, API guides, and workflows
...
**For specific coding patterns and rules, always refer to `.Codex/` Skills first.**
...
- **Bithumb API** - Cryptocurrency market data (Public API)
  ...
  - API Docs: `.Codex/api/bithumb-SKILL.md`, `/bithumb/*.md`
...
**See `.Codex/examples/trading-chart-component.tsx` for more examples.**
...
**See `.Codex/api/bithumb-SKILL.md` for complete API documentation (Bithumb).**

## Important Notes

1. **`.Codex/` Skills**: Always check `.Codex/` directory for detailed coding patterns and anti-patterns
...
This project uses the `.Codex/` directory to store detailed coding conventions and API guides that Codex automatically references.

### Quick Reference

- **Coding standards**: `.Codex/conventions/SKILL.md`
- **Cryptocurrency API patterns**: `.Codex/api/bithumb-SKILL.md` (Bithumb)
- **Git workflow**: `.Codex/workflows/SKILL.md`
- **Code examples**: `.Codex/examples/`
...
The Skills system ensures consistent code quality across the team and provides Codex with project-specific best practices.
