...
├── api/
│   └── bithumb-SKILL.md          # Bithumb API 사용 가이드
├── workflows/
│   └── SKILL.md                # Git 워크플로우 및 커밋 규칙
└── examples/
    └── bithumb-chart-component.tsx  # 차트 컴포넌트 예제
```
...
- **`api/bithumb-SKILL.md`** - Bithumb API 엔티티 및 차트 컴포넌트 사용 가이드
...
- **`.claude/api/bithumb-SKILL.md`**: Bithumb API 관련 **구현 패턴 및 금지 사항**
